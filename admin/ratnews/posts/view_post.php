                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="title" placeholder="Post Title"
                                    value="<?= htmlspecialchars($post['post_title']) ?>" disabled>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Content</label>
                                <div id="editor" style="min-height: 300px;"></div>
                                <textarea readonly name="content" style="display: none;" id="content-input"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea readonly class="form-control" name="excerpt" rows="3"
                    ...
                    <div class="card border shadow-none w-100">
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="category" required>
                                    ...
                                    <option disabled readonly
                                        <?= ($category['id'] == $post['post_category']) ? 'selected' : '' ?>
                            ...
                            <div class="mb-3">
                                ...
                                <input readonly disabled type="file" class="form-control" name="post_image"
                                    accept="image/*">
                            ...
                            <div class="mb-3">
                                ...
                                <input disabled type="text" class="form-control" name="tags"
                            ...
                            <div class="mb-3">
                                ...
                                <textarea disabled readonly class="form-control" name="meta_description" rows="3"
                                    placeholder="SEO description for search engines"><?= htmlspecialchars($post['post_meta_description']) ?></textarea>
                            </div>

                            <div class="mb-3">
                                <div class="form-check">
                                    <input disabled class="form-check-input" type="checkbox" name="is_featured"
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input disabled class="form-check-input" type="checkbox" name="allow_comments"
                            ...
                            <div class="d-grid">
                                ...
                                <a href="view_all_post.php" class="mt-2 btn btn-outline-dark">Back </a>
